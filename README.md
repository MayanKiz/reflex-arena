...
A browser reflex game that measures speed and accuracy while presenting competitive results through a leaderboard flow.

## Quick Start

Run `npm install`, then `npm run dev`. Configure database variables before enabling production leaderboard writes.
